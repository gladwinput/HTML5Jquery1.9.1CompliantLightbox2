...
This script itself (Originally the Lightbox2 script by Lokesh Dhakar) was fantastic, however in HTML5 the rel= attribute did not validate. This was a problem for university work. I've made some small modifications to the script to make up for this drawback. Some mild changes to implementation as well - however otherwise very similar. Thanks to Lokesh for original script.
...
(function() {
  ...
  Lightbox = (function() {
    ...
    Lightbox.prototype.enable = function() {
      var _this = this;
      return $('body').on('click', '.lightbox', function(e) {
    ...
    Lightbox.prototype.start = function($link) {
      ...
      if ($link.attr('class') === '.lightbox') {
        ...
        _ref = $($link.prop("tagName") + '[class="' + $link.prop('class') + '"]');
